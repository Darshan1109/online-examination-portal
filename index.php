...
<div id="developers" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="sushant.jpg" alt="SUSHANT MHATRE" width="400" height="300">
        <p><strong>SUSHANT MHATRE</strong></p>
        <p>A.P.SHAH INSTITUTE OF TECHNOLOG 3rd year B.E</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="darshan.jpg" alt="DARSHAN PATIL" width="400" height="300">
        <p><strong>DARSHAN PATIL</strong></p>
        <p>A.P.SHAH INSITITUTE OF TECHNOLOG 3rd year B.E</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="pratik.jpg" alt="PRATIK INGALE" width="400" height="300">
        <p><strong>PRATIK INGALE </strong></p>
        <p>A.P.SHAH INSTITUTE OF TECHNOLOG  3rd year B.E</p>
      </div>
    </div>
  </div><br>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-map-marker"></span> MUMBAI, MAHARASHTRA, INDIA</p>
      <p><span class="glyphicon glyphicon-phone"></span> +91 07738305400 </p>
      <p><span class="glyphicon glyphicon-envelope"></span> pratikingale@gmail.com</p>
    </div>
...
<script>
function myMap() {
var myCenter = new google.maps.LatLng(19.2660272,72.9637898);
